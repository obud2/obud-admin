  ...
  return (
    ...
    >
      ...
      <DataDetailItem label="연락처" span={2}>
        <Input value={body?.hp || '-'} placeholder="URL을 입력하세요" onChange={(e) => onChangeBody('hp', e.target.value)} readOnly />
      </DataDetailItem>
      ...
      <DataDetailItem label="수업경력" span={2}>
        <Input value={body?.career || '-'} onChange={(e) => onChangeBody('career', e.target.value)} readOnly />
      </DataDetailItem>
