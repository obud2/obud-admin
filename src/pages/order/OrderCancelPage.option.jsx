import { addComma, payStatus } from '../../constants';
...
export const LIST_HEADER = [
  {
    ...
    customBodyRender: (value, data) => {
      return (
        <div>
          <p style={{ fontSize: '11px', fontWeight: 400, color: '#757575' }}>{data?.cancelDate}</p>
    ...
    customBodyRender: (value, data) => {
      ...
      return (
        <div>
          ...
          <p style={{ fontSize: '13px', fontWeight: 500, color: '#232323', margin: '1px 0 3px' }}>{data?.lessonTitle}</p>
