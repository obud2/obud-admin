  ...
  return (
    <React.Fragment>
      ...
      <Descriptions size="small" column={1}>
        <Descriptions.Item label="">최근 30일동안 전송된 메시지를 확인할 수 있습니다.</Descriptions.Item>
        <Descriptions.Item label="">전송결과 완료 후 메시지 전송 실패건은 사용한 충전금/포인트가 재충전됩니다.</Descriptions.Item>
        <Descriptions.Item label="">문자메시지는 최대 72시간, 카카오톡 메시지는 최대 24시간까진 진행중일수 있습니다.</Descriptions.Item>
      </Descriptions>
