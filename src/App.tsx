...
const OrderStatusCalendarPage = lazy(
  () => import("./pages/order/OrderStatusCalendarPage")
);

/* Product */
const ProductListPage = lazy(() => import("./pages/product/ProductListPage"));
const ProductStudioPage = lazy(
  () => import("./pages/product/ProductStudioPage")
);
const ProductLessonPage = lazy(
...
const SettingPolicyPage = lazy(
  () => import("./pages/settings/SettingPolicyPage")
);
const SettingCodePage = lazy(() => import("./pages/settings/SettingCodePage"));
const SettingAuthorityPage = lazy(
  () => import("./pages/settings/SettingAuthorityPage")
);
      ...
      >
        <Layout>
          <Routes>
            ...
            <Route
              path="/pages/order-status/:id"
              element={<OrderStatusCalendarPage />}
            />

            {/* Product */}
            <Route path="/pages/product" element={<ProductListPage />} />
            <Route
              path="/pages/product/studio/:id"
